...
/*
    public static String String_GENUINO101_ledService =
            "2f875daa-422f-11e7-a919-92ebcb67fe33";
...
*/
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            //Humidity
            if(characteristic.getUuid().compareTo(UUID.fromString("00002a6f-0000-0000-fdfd-fdfdfdfdfdfd")) == 0) {
                int val = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 0);
                val=val/100;
                String val_str=Integer.toString(val);
                ConAct.displayData("Humidity value: "+val_str+"%");
                //Local notification
                mBluetoothGatt.setCharacteristicNotification(characteristic,true);
                //Enabling notification
                desc = characteristic.getDescriptors();
                BluetoothGattDescriptor descriptor = desc.get(1);
                descriptor.setValue(BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE);
                gatt.writeDescriptor(descriptor);
            }
        }
...
/*
        ...
        if (UUID_Temperature.equals(characteristic.getUuid())) {
            Toast.makeText(this,"Entered Temp",Toast.LENGTH_LONG);
            ...
            final Float heartRate = characteristic.getFloatValue(format,(int)2);
